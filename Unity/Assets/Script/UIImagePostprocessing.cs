...
[AddComponentMenu("Utils/UI image Postrocessing utility")]
[RequireComponent(typeof (Image))]
public class UIImagePostprocessing : MonoBehaviour {
    ...
    private void OnEnable()
    {
        ...
        {
            targetSprite = targetUIImage.sprite;
    ...
    public void Reset()
    {
        targetUIImage.sprite = targetSprite;
        tempSprite = null;
        tempTexture = null;
    }
    ...
    private void CreateTempSpriteAndTexture()
    {
        ...
        targetUIImage.sprite = tempSprite;
    }
